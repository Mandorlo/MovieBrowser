...
function normFileTitle(fname) {
  ...
  s = s.replace(/[\s\-_\:\.](EXTENDED|ExD|Deceit|MgB|ViSiON|CiNEFiLE|DTS-JYK|GAZ|RmD|AC3\-?|Zen_Bud|ETRG)($|[\s\_\.\-])/g, "")
  s = s.replace(/[\[\]\(\)]/gi, "")
  s = s.replace(/(19|20)[0-9]{2}/gi, "")
  s = s.replace(/[\s\.\-\_](FR|RU|aac|rip|french|subs|hdscene|blu-ray)([\s\.\-\_]|$)/gi, "")
  s = s.replace(/[\.\_]/gi, " ")
  s = s.replace(/\s\s+/gi, " ")
  return s.trim()
}
